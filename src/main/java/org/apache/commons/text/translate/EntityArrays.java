...
public class EntityArrays {
     ...
     */
    @Deprecated
    public static String[][] ISO8859_1_ESCAPE() { return ISO8859_1_ESCAPE_OLD.clone(); }
    private static final String[][] ISO8859_1_ESCAPE_OLD = {
        {"\u00A0", "&nbsp;"}, // non-breaking space
     ...
     */
    @Deprecated
    public static String[][] ISO8859_1_UNESCAPE() { return ISO8859_1_UNESCAPE_OLD.clone(); }
    private static final String[][] ISO8859_1_UNESCAPE_OLD = invert(ISO8859_1_ESCAPE_OLD);
     ...
     */
    @Deprecated
    public static String[][] HTML40_EXTENDED_ESCAPE() { return HTML40_EXTENDED_ESCAPE_OLD.clone(); }
    private static final String[][] HTML40_EXTENDED_ESCAPE_OLD = {
        // <!-- Latin Extended-B -->
     ...
     */
    @Deprecated
    public static String[][] HTML40_EXTENDED_UNESCAPE() { return HTML40_EXTENDED_UNESCAPE_OLD.clone(); }
    private static final String[][] HTML40_EXTENDED_UNESCAPE_OLD = invert(HTML40_EXTENDED_ESCAPE_OLD);
     ...
     */
    @Deprecated
    public static String[][] BASIC_ESCAPE() { return BASIC_ESCAPE_OLD.clone(); }
    private static final String[][] BASIC_ESCAPE_OLD = {
        {"\"", "&quot;"}, // " - double-quote
        {"&", "&amp;"},   // & - ampersand
        {"<", "&lt;"},    // < - less-than
        {">", "&gt;"},    // > - greater-than
     ...
     */
    @Deprecated
    public static String[][] BASIC_UNESCAPE() { return BASIC_UNESCAPE_OLD.clone(); }
    private static final String[][] BASIC_UNESCAPE_OLD = invert(BASIC_ESCAPE_OLD);
     ...
     */
    @Deprecated
    public static String[][] APOS_ESCAPE() { return APOS_ESCAPE_OLD.clone(); }
    private static final String[][] APOS_ESCAPE_OLD = {
        {"'", "&apos;"}, // XML apostrophe
    };
     ...
     */
    @Deprecated
    public static String[][] APOS_UNESCAPE() { return APOS_UNESCAPE_OLD.clone(); }
    private static final String[][] APOS_UNESCAPE_OLD = invert(APOS_ESCAPE_OLD);
     ...
     */
    @Deprecated
    public static String[][] JAVA_CTRL_CHARS_ESCAPE() { return JAVA_CTRL_CHARS_ESCAPE_OLD.clone(); }
    private static final String[][] JAVA_CTRL_CHARS_ESCAPE_OLD = {
        {"\b", "\\b"},
        {"\n", "\\n"},
        {"\t", "\\t"},
        {"\f", "\\f"},
     ...
     */
    @Deprecated
    public static String[][] JAVA_CTRL_CHARS_UNESCAPE() { return JAVA_CTRL_CHARS_UNESCAPE_OLD.clone(); }
    private static final String[][] JAVA_CTRL_CHARS_UNESCAPE_OLD = invert(JAVA_CTRL_CHARS_ESCAPE_OLD);
